...
import { IExternalLoginRequest, IForgotPassword, IForgotPasswordResponse, ILoginRequest, IRegisterRequest } from "../../../interfaces/account.interface";
...
export const register = createAction(REGISTER_INIT, props<{ data: IRegisterRequest }>());
export const register_success = createAction(REGISTER_SUCCESS, props<{ message: string }>());
export const register_failure = createAction(REGISTER_FAILURE, props<{ error: string }>());