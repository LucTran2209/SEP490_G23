namespace BE.Persistence.Common
{
    public static class ConstantTableNames
    {
        ...
        //internal const string RentalRequestStatuses = nameof(RentalRequestStatuses);  
        internal const string Orders = nameof(Orders);
        internal const string OrderDetails = nameof(OrderDetails);
        internal const string OrderStatuses = nameof(OrderStatuses);
        internal const string RentalRequestProducts = nameof(RentalRequestProducts);
        internal const string RentalShops = nameof(RentalShops);
